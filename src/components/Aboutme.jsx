      ...
      <>
        <section id="about_me" className="mt-[30px] text-zinc-50 w-full bg-zinc-950 max-w-[1920px]">
            ...
            <div className="w-full flex flex-col items-center  min-[1000px]:flex-row justify-around">
                <img className="hidden  min-[1000px]:block w-5/12" src="https://static.vecteezy.com/system/resources/previews/035/593/765/non_2x/ai-generated-happy-boy-cartoon-ai-generative-free-png.png" />
