function Skillsandtools() {
    return (
        <section id="skills_and_tools" className="mt-[30px] w-full max-w-[1920px] bg-zinc-950 flex flex-col items-center">
                    ...
                    <svg version="1.1" x="0px" y="0px"
                        ...
                        <g id="Layer_2_1_">
                            <g id="Surfaces">
                                <g id="Photo_Surface">
                                    <g id="Outline_no_shadow">
                                        <path class="fill-[#001E36]" d="M42.5,0h155C221,0,240,19,240,42.5v149c0,23.5-19,42.5-42.5,42.5h-155C19,234,0,215,0,191.5v-149
                                            C0,19,19,0,42.5,0z"/>
                                    </g>
                                </g>
                            </g>
                            <g id="Outlined_Mnemonics_Logos">
                                <g id="Ps">
                                    <path class="fill-[#31A8FF]" d="M54,164.1V61.2c0-0.7,0.3-1.1,1-1.1c1.7,0,3.3,0,5.6-0.1c2.4-0.1,4.9-0.1,7.6-0.2c2.7-0.1,5.6-0.1,8.7-0.2
                                    ...
                                    <path class="fill-[#31A8FF]" d="M192,106.9c-3-1.6-6.2-2.7-9.6-3.4c-3.7-0.8-7.4-1.3-11.2-1.3c-2-0.1-4.1,0.2-6,0.7c-1.3,0.3-2.4,1-3.1,2
