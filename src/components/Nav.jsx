  ...
  const handleClick = () => {
    ...
    return (
      <>
        ...
        <section className={isToggled ? 'z-20 w-full max-w-[350px] min-[800px]:hidden right-0 h-screen fixed bg-zinc-950 max-w-[1920px] flex flex-col items-center justify-between right-[-350px] transition-all' : 'z-20 transition-all w-full max-w-[350px] min-[800px]:hidden right-0 h-screen fixed bg-zinc-950 max-w-[1920px] flex flex-col items-center justify-between'} id="nav">
