    ...
    return (
      <section id="intro" className="pt-[55px] flex flex-col items-center text-zinc-50 w-full bg-zinc-950 max-w-[1920px] min-[800px]:flex-row-reverse justify-around">
        ...
        <span className="p-[30px] flex flex-col items-center min-[800px]:w-6/12 min-[800px]:items-start">
            ...
            <p className="p-[10px] line-clamp-5 text-[14px] text-center min-[400px]:text-[18px] min-[400px]:p-[15px] min-[600px]:text-[20px] min-[600px]:p-[20px] min-[800px]:text-left min-[800px]:p-[30px] min-[800px]:text-[22px] min-[1000px]:text-[24px] min-[1000px]:px-[40px] min-[1300px]:px-[60px] min-[1300px]:text-[30px] leading-normal">
            Welcome to my world of creativity. I bring ideas to life through bold visuals, thoughtful design, and unique perspectives.
            </p>
        </span>
    </section>
    )
